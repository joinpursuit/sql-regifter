...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('dinner candle', 'Bolsius', '12.96', TRUE),
('ocean mist & sea salt classic candle', 'NEST', '44', TRUE),
('bonsai tree light', 'Amazon', '17.99', FALSE),
('photo moon lamp', 'Yourphotostucks', '19.95', TRUE),
('flameless wax candle', 'Pottery Barn', '250', FALSE),
('grapefruit candle', 'NEST', '44', TRUE)
;
