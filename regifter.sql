...
gift text, giver text, value int, previously_regifted bool);
-- 
...
but maybe change value to price?

ALTER TABLE gifts RENAME value TO price
-- 
\echo Insert a peach candle, given by 'Santa' thats value is 9 and has been previously regifted
-- 
carloecheverri=# INSERT INTO 
carloecheverri-# gifts (gift, giver, value, previously_regifted)
carloecheverri-# VALUES
carloecheverri-# ('peach candle', 'Santa', 9, true);
...
VALUES
('gucci candle', 'dog', 999, false),           
('tesla', 'elon', 40000, false),    
('condo', 'bezos', 100000, false),                     
('yeezys', 'cat', 200, true),                       
('socks', 'granma', 20, true);          
