...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES 
('Cherry Blossom', 'Veli', 11, FALSE),
('Chanel Perfume', 'Josh', 39, FALSE),
('Earrings', 'Ashley', 21, TRUE),
('Apple Watch', 'Cristal', 150, FALSE),
('Violin', 'Violet', 100, TRUE);
...
-- 
UPDATE gifts SET value = 299 WHERE id=2;

--
\echo Query for the updated item
--
UPDATE gifts SET value = 299 WHERE id = 2 RETURNING *;
