...
DROP DATABASE regifted;
CREATE DATABASE regifted;
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('pepermint candle', 'Younes', 49, TRUE),
('bicicle', 'Andres', 30, TRUE),
('electric train', 'Angie', 99, TRUE),
('legos', 'Jose', 50, FALSE),
('soccer ball', 'Colin', 30, TRUE);
SELECT * FROM gifts;
...
-- 
SELECT FROM gifts COUNT WHERE gift LIKE '%candle%';
