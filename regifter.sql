...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('peanut butter soup', 'Colin', 8, TRUE),
('lavender candle', 'Angie', 35, FALSE),
('42 inch hp monitor', 'Jose', 45, TRUE),
('gaming chair', 'Isidro', 31, TRUE),
('amazon prime', 'John', 99, FALSE);
...
-- Would this be a better anwesr to the question
