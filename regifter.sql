...
-- 
INSERT INTO 
gift(gift, giver, price, previously_regifted)
VALUES
...
('peaches & cream', '112', '10', FALSE),
('Kryptonite', '3 Door Down', '19', TRUE),
('Scrubs', 'TLC', '135', FALSE),
('Halo', 'Beyonce', '64', FALSE),
('strawberry candle', 'Johnathan', '9', TRUE);
