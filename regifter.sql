...
-- 
ALTER TABLE price RENAME TO value;
...
VALUES  
    ('ps5', 'Mommy', '18', FALSE);
    ('guitar', 'Dad', '15', FALSE);
    ('keyboard', 'Dad', '10', FALSE);
    ('specialty pasta', 'Aunt Blossom', '19', TRUE);
    ('hemp lotion', 'Mommy', '22', TRUE);
...
--
SELECT * FROM gifts WHERE giver = Santa || value > 30;
