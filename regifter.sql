...
-- 
-- CHRISTINA: confused because there is no price column..???
ALTER TABLE gifts RENAME price TO value;
-- ERROR:  column "price" does not exist.
-- CHRISTINA: changing it to price, and then changing it back to value..???
...
--
-- CHRISTINA: already inserted the first one. Inserting only 4 more gifts:
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('cinnamon candle', 'Nick', '19', TRUE),
('soap on a rope', 'Rudolf', '29', FALSE),
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('hotdog candle', 'Nathan', '16', TRUE),
('snow boots', 'Elsa', '64', FALSE),
('clown doll', 'Pennywise', '86', TRUE),
('direwolf skull', 'Jon Snow', '18', FALSE),
('glow in the dark candle', 'Lumiere', '91', FALSE)
;
...
--
-- CHRISTINA: using 'value' instead of 'price' because we are using value.
