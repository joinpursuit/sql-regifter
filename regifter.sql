...
-- I wrote the command although we created column value in our 1st step
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('lavender candle', 'Maria', 29, TRUE),
('small mirror', 'Thomas', 14, FALSE),
('huge painting', 'Peter', 199, TRUE),
('a doll', 'creepy neighbor', 1, TRUE),
('good chocolate', 'John', 26, FALSE)
;
...
--
SELECT * FROM gifts WHERE value >= 20 ORDER BY value;
...
--
SELECT gift FROM gifts WHERE giver ILIKE '%santa%' OR value > 30;
...
--
SELECT * FROM gifts ORDER BY value DESC OFFSET 2;
