...
-- 
INSERT INTO
gifts (gift, giver, price, previously_regifted) VALUES ('peach candle', 'Santa', 9, TRUE) ;
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('mint candle', 'Sabrina', '10', TRUE),
('cake', 'Isaac', '25', FALSE),
('candies', 'Allison', '15', FALSE),
('shirt', 'Mariela', '24', TRUE),
('fruits', 'Kevin', '12', TRUE)
;
