...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('lavender body wash', 'Eddy', '25', FALSE),
('bike', 'Arabelis', '58', FALSE),
('mud mask', 'Santa', '15', TRUE),
('tea making kit', 'Jomayli', '39', FALSE),
('blender', 'The Boss', '49', TRUE)
;
...
-- WORKED ON BONUS BEFORE WORKING ON DELETE!
--
...
-- BONUSES
-- WORKED ON THESE BEFORE WORKING ON DELETE!
--
