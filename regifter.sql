...
CREATE TABLE 
    gifts (id serial, gift TEXT, giver TEXT, value INT, previously_regifted BOOLEAN);
...
INSERT INTO 
    gifts (gift, giver, value, previously_regifted)
VALUES
    ('Pumpkin pie', 'Jeremy', '10', FALSE),
    ('Water bottle', 'Katie', '15', TRUE),
    ('Alarm clock', 'Luke', '40', FALSE),
    ('Headphones', 'Mario', '60', TRUE),
    ('Sunglasses', 'Cynthia', '70', FALSE),
    ('Strawberry candle', 'Joanna', '10', TRUE)
    ;
