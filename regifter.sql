...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('mint candle', 'Sister', 10, TRUE),
('Patagonia Jacket', 'Mom', 299, TRUE),
('PS 5', 'Dad', 500, TRUE),
('Macbook Pro M2', 'Boss', 1299, TRUE),
('Gaming chair', 'Amazon', 499, TRUE)
;
...
--
SELECT * FROM gifts ORDER BY value DESC LIMIT 3 OFFSET;
--
-- finish
--
