...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Lemon and Lavender Shortbread candle', 'Santa', '31', FALSE),
('Lavender and Cedarwood candle', 'Nick', '26', TRUE),
('Iced Vanilla Woods candle', 'Rudolf' '25', TRUE),
('Black Teakwood candle', 'Elf on the Shelf', '26', FALSE),
('Snow Mountain Lodge candle', 'The Boss', '25', TRUE),
