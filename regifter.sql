...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('apple ipod pro', 'Lori', '130', FALSE),
('rose soap', 'Sandy', '8', FALSE),
('lavender essential oil', 'Ruby', '18', TRUE),
('elderberry Epson Salt', 'Larry', '12', TRUE),
('ginseng honey face mask', 'Florence', '8', FALSE),
('passion fruit candle', 'Ping', '15', FALSE)
;
