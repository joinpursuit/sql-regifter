...
CREATE TABLE gifts ( id serial, gift TEXT, giver TEXT, valus INT, previously_regifted BOOLEAN  );
ALTER TABLE gifts RENAME valus TO value;
-- 
...
INSERT INTO gifts (gift, giver, price, previously_regifted) 
VALUES 
('chap stick', 'Ben', '7', FALSE),
('tv remote', 'Todd', '49', FALSE),
('chew toy', 'Roxy', '30', FALSE),
('beard oil', 'Frank', '20', FALSE),
('mud mask', 'Matt', '20', FALSE)
;
