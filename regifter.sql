...
CREATE TABLE
  gifts
  (id serial, gift TEXT, giver TEXT, price INT, previously_regifted BOOLEAN DEFAULT);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
 VALUES
 ('magnolia candle', 'Santa', '9', TRUE),
 ('lavender soap','Nick', 10, FALSE),
( 'vase','Rudolf', 5, FALSE),
( 'table runner','Mrs.Claus', 9, FALSE),
( 'vase','Nick', 4, TRUE);
--
