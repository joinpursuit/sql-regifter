...
CREATE TABLE
  gifts
  ( id serial primary KEY, gift TEXT NOT NULL, giver TEXT, value INT, previously_regifted BOOLEAN);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('chocolate-chip Candle', 'Jim', '15', FALSE),
('autographed baseball', 'christian', '99', FALSE),
('hand towels', 'mom', '29', FALSE),
('T-shirt', 'gaby', '19', FALSE),
('sweater', 'dad', '39', TRUE)
;
...
--
SELECT * FROM gifts WHERE giver = 'Santa' or Value > 20;
