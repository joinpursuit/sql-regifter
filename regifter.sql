...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES  
('Vanilla Candle', 'Hafiz', '10', False),
('Melon candle', 'Rick', '20', False),
('Strawberry Candle', 'Woodrof', '30', True),
('Plain Candle', 'Hamilton', '40', FALSE),
('White Stone Candle', 'Hillary', '50', True),
('Black Diamond Candle', 'Robert', '69', False)
;
...
--
SELECT gift FROM gifts WHERE giver NOT ILIKE 'SANTA';
