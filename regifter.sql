...
CREATE TABLE gifts (id serial, gift TEXT, giver TEXT, val INT, previously_regifted BOOLEAN);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('socks', 'Brian', '15', FALSE),
('lavender candle', 'Tony', '19', TRUE),
('art', 'Denisse', '60', FALSE),
('chipotle gift card', 'Carlos', '25', FALSE),
('towels', 'Secret Santa', '20', TRUE)
;
