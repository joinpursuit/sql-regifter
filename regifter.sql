...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT NOT NULL, giver TEXT, price INT, previously_regifted BOOLEAN DEFAULT false);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Blue Jean Baby candle', 'Daniel', 36, FALSE),
('Torus dog bowl', 'Danny', 49, FALSE),
('NetworkChuck Coffee', 'Szandra', 12, FALSE),
('Iphone 12 proMax toy', 'Apple', 1, FALSE),
('nylabondog bone', 'Gabby', 4, TRUE)
;
