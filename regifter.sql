...
-- regifter-# VALUES ('peach candle', 'Santa', '9', TRUE);
...
regifter-# VALUES ('cinnamon candle', 'Nick', '19', TRUE),
...
-- VALUES ('apple candle', 'Jess', '17', TRUE), 
-- ('baseball', 'Pumpkin', '4', TRUE), 
-- ('guitar', 'Dolly', '21', TRUE),
-- ('shoes', 'Sunny', '3', FALSE),
-- ('crayons', 'Ricky', '0', TRUE);
