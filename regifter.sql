...
--
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES ('Birthday Cake Candle', 'Bob', 25, FALSE),
('Netflix Sub', 'Nicole', 30, FALSE),
('Starcraft 2', 'Mike', 15, TRUE),
('Nothing', 'Herman', 0, TRUE),
('Epson Printer', 'Malcolm', 299, FALSE);
...
SELECT gift FROM gifts WHERE gift LIKE '%Candle%';
/* One of the candles I inserted has a capital C in it.*/
--
