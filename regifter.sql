...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT, giver TEXT, value INT, previously_regifted BOOLEAN DEFAULT false);
...
--
('vanilla cupcake candle', 'Fionn', '52', TRUE),
('pumpkin spice candle', 'Mu', '40', TRUE),
('linen candle', 'Shin', '30', FALSE),
('evergreen candle', 'La', '20', TRUE),
('lavender candle', 'Del', '25', FALSE);
