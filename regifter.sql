...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Kiku Ichimonji', 'Soldoros', 200000, FALSE),
('Strahl', 'Balthier', 50000, TRUE),
('Blade of Olympus', 'Kratos', 200000, FALSE),
('Mobile Suit Gundam: Wing Zero', 'Hero', 500000, TRUE),
('The Emerald Tablet of Thoth', 'Hermes Trismegistus', 1000000, FALSE)
;
--
