...
CREATE TABLE gifts (id SERIAL, gift TEXT, giver TEXT, price INTEGER, previously_regifted BOOLEAN DEFAULT false);
...
-- INSERT INTO gifts (gift, giver, value, previously_regifted) VALUES 
-- ('coconut candle', 'Randy', '29', FALSE),
-- ('cocomelon', 'Uncle Bill', '45', FALSE),
-- ('cerave', 'Fatema', '12', FALSE),
-- ('pelaton', 'Rose', '400', TRUE),
-- ('silk robe', 'Fatema', '250', TRUE);
