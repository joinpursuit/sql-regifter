...
CREATE TABLE gifts (id serial PRIMARY KEY, gift VARCHAR, giver VARCHAR, value INT, previously_regifted BOOL);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('mango candle', 'Bob', '10', TRUE),
('vanilla candle', 'Cindy', '20', TRUE),
('flowers', 'Jake', '29', FALSE),
('socks', 'Steve', '20', FALSE),
('money', 'The Boss', '50', FALSE);
