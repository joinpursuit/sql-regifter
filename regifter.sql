...
-- 
CREATE TABLE gifts (id serial, gift TEXT NOT NULL, giver TEXT NOT NULL, price INT, previously_regifted BOOLEAN);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES 
('lavender vanilla candle', 'mother', 59, TRUE),
('tea', 'Ariel', 69, TRUE),
('poison', 'adversary', 79, FALSE),
('blueberry scone candle', 'Melissa', 89, TRUE),
('macdonalds', 'Fat Jack', 99, FALSE)
;
