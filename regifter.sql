...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT, giver TEXT, value INTEGER, prviously_regifted BOOLEAN);
...
--
-- This table was already created to have value as one of the columns. I altered the column to have price and then reverted it to value.
...
--
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES ('bath robe', 'Samantha', '15', FALSE),
('video games', 'Chris', '60', FALSE),
('bath and bodyworks candle', 'Cupid', '20', FALSE),
('baking dish', 'Nancy', '10', TRUE),
('big bang theory blueray', 'Santa', '25', TRUE);
...
--
SELECT value FROM gifts WHERE id = 2;
