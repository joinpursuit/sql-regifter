...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift VARCHAR(150), giver VARCHAR(50), value INTEGER, previously_regifted BOOLEAN default false);
-- 
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES 
('eye glasses', 'Mom', 90, FALSE),
('puppy', 'Nick', 59, TRUE),
('pants', 'Bob', 5, FALSE),
('shirt','Melissa', 56, TRUE),
('socks', 'John', 43, FALSE),
('lavendar candle', 'Bill', 32, TRUE)
...
--
SELECT id, gift, giver, price, previously_regifted FROM gifts WHERE id = 2;
