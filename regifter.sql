...
CREATE TABLE gifts (id SERIAL, gift TEXT, giver TEXT, price INT, previously_regifted BOOLEAN DEFAULT false);
...
--
INSERT INTO gifts (gift, giver, value, previously_regifted) VALUES ('Soap', 'Elmo', 12, true), ('Toy Car', 'Santa', 30, false), ('A Company', 'Taylor', 100000000, false), ('Canday', 'Santa', 5, true), ('Jordan 1s', 'Bryant', 250, false);
...
--
SELECT SUM(value) FROM gifts;

-- 
 \echo Limit to 3 gifts, offset by 2 and order by price descending
--
SELECT gift FROM gifts ORDER BY value ASC LIMIT 3 OFFSET 2;
--
-- finish
--
