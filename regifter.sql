...
CREATE TABLE 
	gifts 
	(id SERIAL PRIMARY KEY, gift VARCHAR, giver VARCHAR, value INT, previously_regifted BOOLEAN);
...
VALUES
('Apple candle', 'James', '9', TRUE),('cinnamon candle', 'Nick', '19', TRUE),('soap on a rope', 'Rudolf', '29', FALSE),('potpurri', 'Elf on the Shelf', '39', TRUE),('mango candle', 'The Boss', '49', FALSE);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('Orange candle', 'Mia', '19', false),('tree candle', 'Juan', '8', false),('pine', 'Saint', '13', TRUE),('barf', 'Goonies', '1', TRUE),('pineapple candle', 'MERICA', '99', true);
